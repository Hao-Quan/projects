...
'''
This script is aim to convert calo's data from h5 to numpy. 
The original h5 file "data_training_test.h5" is already with "shuflle"
'''


f = h5py.File("data_training_test.h5", 'r')
print(f.keys())

# <KeysViewHDF5 ['test_data', 'test_label', 'train_data', 'train_label']>

train_data = pd.read_hdf("data_training_test.h5", "train_data").values
test_data = pd.read_hdf("data_training_test.h5", "test_data").values

train_label = pd.read_hdf("data_training_test.h5", "train_label").values
test_label = pd.read_hdf("data_training_test.h5", "test_label").values
