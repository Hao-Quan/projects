...
with open('train_data_joint_without_shuffle.npy', 'wb') as f:
    np.save(f, z)
...
z = np.expand_dims(z, axis=2)
z = np.expand_dims(z, axis=4)
with open('test_data_joint_without_shuffle.npy', 'wb') as f:
    np.save(f, z)

with open('train_label_without_shuffle.pkl', 'wb') as f:
    pkl.dump(train_label, f)

with open('test_label_without_shuffle.pkl', 'wb') as f:
