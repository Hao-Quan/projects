...
if __name__ == "__main__":
    ...
    with open(os.path.join(arg.upper_dir, 'xview/joint/bs_64', 'upper_test_score.pkl'), 'rb') as r1:
        r1 = pickle.load(r1)

    with open(os.path.join(arg.lower_dir, 'xview/joint/bs_64', 'lower_test_score.pkl'), 'rb') as r2:
    #with open(os.path.join(arg.lower_dir, 'lower_test_score.pkl'), 'rb') as r2:
        r2 = pickle.load(r2)

    # 2 streams

    with open(os.path.join(arg.upper_dir, 'xview/bone', 'upper_test_score.pkl'), 'rb') as r3:
    #with open(os.path.join(arg.upper_dir, 'upper_test_score.pkl'), 'rb') as r1:
        r3 = pickle.load(r3)

    with open(os.path.join(arg.lower_dir, 'xview/bone', 'lower_test_score.pkl'), 'rb') as r4:
    #with open(os.path.join(arg.lower_dir, 'lower_test_score.pkl'), 'rb') as r2:
        r4 = pickle.load(r4)

    # 4 streams
    #joint motion
    with open(os.path.join(arg.upper_dir, 'xview/joint_motion', 'upper_test_score.pkl'), 'rb') as r5:
    #with open(os.path.join(arg.upper_dir, 'upper_test_score.pkl'), 'rb') as r1:
        r5 = pickle.load(r5)

    with open(os.path.join(arg.lower_dir, 'xview/joint_motion', 'lower_test_score.pkl'), 'rb') as r6:
    #with open(os.path.join(arg.lower_dir, 'lower_test_score.pkl'), 'rb') as r2:
        r6 = pickle.load(r6)

    #bone motion
    with open(os.path.join(arg.upper_dir, 'xview/bone_motion', 'upper_test_score.pkl'), 'rb') as r7:
    #with open(os.path.join(arg.upper_dir, 'upper_test_score.pkl'), 'rb') as r1:
        r7 = pickle.load(r7)

    with open(os.path.join(arg.lower_dir, 'xview/joint_motion', 'lower_test_score.pkl'), 'rb') as r8:
    #with open(os.path.join(arg.lower_dir, 'lower_test_score.pkl'), 'rb') as r2:
        r8 = pickle.load(r8)
