...
class CaloDataLoaders(object):
    def __init__(self, dataset ='NTU', case = 0, aug = 1, seg = 30):
        ...
        self.train_set = CaloDataset(self.train_X, self.train_Y) # train_set.x (35763, 300, 150); train_set.y (35763)
        #self.val_set = NTUDataset(self.val_X, self.val_Y)      # (1883)
        self.test_set = CaloDataset(self.test_X, self.test_Y)   # ()
    ...
    def create_datasets(self):
        ...
        with open(path + 'test_label.pkl', 'rb') as f:
