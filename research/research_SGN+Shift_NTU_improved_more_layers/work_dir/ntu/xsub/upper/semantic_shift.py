...
class Model(nn.Module):
    ...
    def __init__(self, num_class=60, num_joint=19, num_person=2, seg=1, args=None, bias=True, graph=None, graph_args=dict()):
        ...
        self.l2 = TCN_GCN_unit(64, 64, self.metric, A, tem=self.tem)
        self.l3 = TCN_GCN_unit(64, 64, self.metric, A, tem=self.tem)
        self.l4 = TCN_GCN_unit(64, 64, self.metric, A, tem=self.tem)
        self.l5 = TCN_GCN_unit(64, 128, self.metric, A, tem=self.tem, stride=2)
        self.l6 = TCN_GCN_unit(128, 128, self.metric, A, tem=self.tem)
        self.l7 = TCN_GCN_unit(128, 128, self.metric, A, tem=self.tem)
        self.l8 = TCN_GCN_unit(128, 256, self.metric, A, tem=self.tem, stride=2)
        self.l9 = TCN_GCN_unit(256, 256, self.metric, A, tem=self.tem)
        self.l10 = TCN_GCN_unit(256, 256, self.metric, A, tem=self.tem)
