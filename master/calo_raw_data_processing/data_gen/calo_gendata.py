...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Calo Data Converter.')
    parser.add_argument('--data_path', default='../1_carosello/')
    # parser.add_argument('--ignored_sample_path',
    #                     default='../data/nturgbd_raw/NTU_RGBD_samples_with_missing_skeletons.txt')
    parser.add_argument('--out_folder', default='../data/calo/')
